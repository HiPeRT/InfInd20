package Process;
// Change the actual mode of the system, send a msg in the changer topic and then the controller change the mode
...
public class ChangeMode {
    ...
    private static final String TOPIC = "traffic_light/Changer";
    ...
    public static void main(String[] args) throws MqttException {
        ...
        publishData(client,TOPIC,"change mode");
    }
